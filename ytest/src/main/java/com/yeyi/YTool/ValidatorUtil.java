...
//        System.out.println("过滤中英文特殊字符: "+ValidatorUtil.stringFilter("中国~~!#$%%."));
//        System.out.println("是否包含中英文特殊字符: "+ValidatorUtil.isContainsSpecialChar("12"));
////        System.out.println("过滤html代码: "+ValidatorUtil.htmltoText("<JAVASCRIPT>12</JAVASCRIPT>DDDDD"));
//        System.out.println("判断中文字符: "+ValidatorUtil.isChineseChar("中国！"));
//        System.out.println("匹配汉字: "+ValidatorUtil.isChinese("中国！"));
//        System.out.println("判断英文字符: "+ValidatorUtil.isEnglish("abc!"));
//        System.out.println("判断合法字符: "+ValidatorUtil.isRightfulString("abc_-11AAA"));
//        System.out.println("邮政编码验证: "+ValidatorUtil.isZipCode("162406"));
//        System.out.println("身份证号码验证: "+ValidatorUtil.isIdCardNo("35052419880210133e"));
        System.out.println("手机号码验证: "+ValidatorUtil.isMobile("18918611111"));
        System.out.println("邮箱验证: "+ValidatorUtil.isEmail("abc@126.com"));
//        System.out.println("电话号码验证: "+ValidatorUtil.isPhone("8889333"));
//        System.out.println("电话号码验证: "+ValidatorUtil.isNumeric("888.9333"));
//        System.out.println("匹配密码: "+ValidatorUtil.isPwd("d888d_ddddd"));
//        System.out.println("匹配密码: "+ValidatorUtil.isUrl("http://baidu.com"));
//        System.out.println("验证字符: "+ValidatorUtil.stringCheck("中文aabc001_-"));
...
//        return match(text, "^((13[0-9])|(14[5|7])|(15([0-3]|[5-9]))|(18[0,5-9]))\\d{8}$");
        return match(text, "1[34578][0-9]{9,9}");
    }
...
//        return match(text, "(\\d{14}[0-9a-zA-Z])|(\\d{17}[0-9a-zA-Z])"); // 身份证
//        // 要么是15位，要么是18位，最后一位可以为字母
    }
