...
@Repository
public class DBDao extends BaseDao<Track>{
	@Autowired
	...
	public int updateLastVisitDateById(String id, String lastVisit) {
		...
		track.setLastVisit(lastVisit);
		track.setFromId(null);
		track.setFromType(null);
		track.setJid(null);
		track.setUploaderJid(null);
		track.setId(Integer.parseInt(id));
		return update(track, "t_customer_im_track", "id");
//		int result = -1;
//		try {
//				StringBuilder sb = new StringBuilder();
...
//		return result;
	...
	public int insertTrack(Track ta){
		return this.insert(ta,"t_customer_im_track");
//		int result = -1;
//		
//		try{
//			Map<String, Object> paramMap = new HashMap<String, Object>();
